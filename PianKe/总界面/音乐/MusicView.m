...
- (void)setupAutoLayout
{
    ...
    [view.iconView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.mas_equalTo(view.mas_centerX).offset(SCREENWIDTH * 0.3);
    }];
...
{
//    //发送网络请求
//    NSString *song = [NSString stringWithFormat:@"%ld",songid];
//    NSDictionary *params = @{
//                             @"method" : @"Songs.getTrackDetail",
//                             @"id" : song,
//                             @"device_id" : @"1111",
//                             @"av" : @"ios_3.0",
//                             @"call_id" : @"1458117484.939133",
//                             @"api_sig" : @"b9508eb735fb6fbba2c64c2e824f626c",
//                             @"quality" : @"l",
//                             @"api_key" : @"677e062bd25a6b4d42917f6c88cd7b6d"
//                             };
//    [HttpTool getWithPath:@"http://api.xiami.com/api" params:params success:^(id JSON) {
//        
//        NSDictionary *dataDic = JSON[@"data"];
//        self.songModel = [SongModel mj_objectWithKeyValues:dataDic];
//        
//        //给子控件设置数据
//        [self updata];
//        
